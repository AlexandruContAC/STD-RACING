...
# Image processing
# ---------------------------------------------------------------------------
THRESHOLD_VALUE = 45  # 0-255, pixels darker than this become white after INV
...
# ---------------------------------------------------------------------------
SCAN_LINE_ROWS    = [190,185,180,175,170,165,160,155,150,145,140,135,130,125,120,115,110,105,100,90,80,70,60]
...
SCAN_LINE_WEIGHTS = [0.010, 0.015, 0.020, 0.025, 0.030, 0.035, 0.040, 0.040, 0.040, 0.040, 0.045, 0.045, 0.045, 0.045, 0.050, 0.050, 0.050, 0.050, 0.055, 0.060, 0.065, 0.070, 0.075]  # sum = 1.0
...
ASSUMED_LANE_WIDTH = 320

# ---------------------------------------------------------------------------
# Steering
# ---------------------------------------------------------------------------
STEERING_KP = 0.032   # proportional gain
STEERING_KI = 0.0    # integral gain   (stubbed)
STEERING_KD = 0.026    # derivative gain (stubbed)
...
LIDAR_BRAKE_THRESHOLD_CM = 20.0        # Emergency brake if obstacle closer than this (cm)
